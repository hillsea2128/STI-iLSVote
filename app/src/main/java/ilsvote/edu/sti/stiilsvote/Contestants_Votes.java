...
public class Contestants_Votes {
    public String proj_title;
    public String class_sect;
    public String proj_desc;
    public String proj_ID;
    public String proj_group;
    public String proj_votes;
    public String short_proj_desc;
    public String raw_img;
    public Contestants_Votes(){
        super();
    }

    public Contestants_Votes(String title1, String sect1, String desc1, String bytes_img, String proj_ID, String proj_group, String proj_votes) {
        super();
